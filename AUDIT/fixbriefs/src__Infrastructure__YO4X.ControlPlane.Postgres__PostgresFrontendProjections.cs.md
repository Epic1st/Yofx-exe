...
[1] [P1] PostgreSQL `numeric(12,2)` volume columns and projection validator reject fractional lot sizes
    ...
    Suggested fix: Update schema volume columns to `numeric(18,8)` and update `RequireTradableVolume` to allow up to 8 decimal places.
