...
[1] [P2] Fallback binding diagnostics are discarded when semantic model is rebound
    ...
    Suggested fix: Accumulate `bound.Diagnostics` and merge them into the returned `Mql5CodeGenResult.Diagnostics`.
