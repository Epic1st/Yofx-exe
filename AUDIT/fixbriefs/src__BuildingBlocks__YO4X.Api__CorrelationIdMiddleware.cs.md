...
[1] [P3] `CorrelationIdMiddleware.Get` generates unpersisted ephemeral IDs when invoked on uninitialized contexts
    ...
    Suggested fix: Store the newly created correlation ID in `context.Items[ItemKey]` before returning it: `string generated = CreateCorrelationId(); context.Items[ItemKey] = generated; return generated;`.
