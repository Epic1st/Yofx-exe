...
[1] [P3] Attestation Constructor Silently Truncates Oversized Signatures Instead of Rejecting Them
    ...
    Suggested fix: Validate `signature.Length <= Mql5CompileValidation.MaximumAttestationSignatureBytes` (256 bytes) and throw `ArgumentOutOfRangeException` on oversized inputs.
