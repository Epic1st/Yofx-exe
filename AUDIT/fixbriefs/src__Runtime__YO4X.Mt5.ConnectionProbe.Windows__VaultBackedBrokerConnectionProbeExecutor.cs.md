...
[1] [P2] Probe executor conflates invalid credentials with transport failures, creating account lockout risk
    ...
    Suggested fix: Distinguish vendor authentication and bad-password exceptions from transport-level network faults and return distinct result status codes.
