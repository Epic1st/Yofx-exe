...
[1] [P3] Hardcoded literal RGB value in `global.css` bypasses design tokens
    ...
    Suggested fix: Replace `rgb(255 255 255 / 86%)` with `color-mix(in srgb, var(--color-surface) 86%, transparent)`.
