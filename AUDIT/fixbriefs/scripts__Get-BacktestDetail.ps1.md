...
[1] [P3] `Get-BacktestDetail.ps1` declares `$StrategyId` for backtest route with mismatched docstring
    ...
    Suggested fix: Rename `$StrategyId` to `$BacktestId` and update the synopsis docstring to reflect backtest detail inspection.
