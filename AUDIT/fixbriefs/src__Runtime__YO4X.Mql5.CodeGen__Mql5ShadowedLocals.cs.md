...
[1] [P2] Shadowed locals analysis terminates at depth 64 while generator allows depth 200
    ...
    Suggested fix: Synchronize the recursion depth limit in `Mql5ShadowedLocals.Walk` with `Mql5GeneratorRun.MaxDepth` (200).

[2] [P2] Synthetic shadow names can collide with user identifiers declared in outer scopes
    ...
    Suggested fix: Verify generated shadow names against all identifiers present in enclosing scopes and increment the ordinal until an unused identifier is found.
