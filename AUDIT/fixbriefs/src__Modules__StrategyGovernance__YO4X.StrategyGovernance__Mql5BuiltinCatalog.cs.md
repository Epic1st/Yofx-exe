...
[1] [P3] `Mql5BuiltinCatalog.IsKnown` omits `Mql5BuiltinRealConstants`
    ...
    Suggested fix: Include `|| Mql5BuiltinRealConstants.IsKnown(name)` in the boolean expression of `Mql5BuiltinCatalog.IsKnown(string name)`.
