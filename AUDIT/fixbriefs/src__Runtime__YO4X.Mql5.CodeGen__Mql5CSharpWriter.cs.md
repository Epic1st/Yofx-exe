...
[1] [P3] Line directive deduplication suppresses directives when lines advance between statements
    ...
    Suggested fix: Clear or update `_lastDirectiveLine` whenever lines are written to `_builder`, or track the actual active compiler line rather than only the last requested directive line.
