...
[1] [P3] AdminSession.RequireFreshStepUp does not reject future authentication timestamps
    ...
    Suggested fix: Update `RequireFreshStepUp` to validate `if (AuthenticatedAt > now || now - AuthenticatedAt > maximumAge)`.
