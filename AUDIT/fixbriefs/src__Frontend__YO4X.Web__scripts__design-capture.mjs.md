...
[1] [P3] Duplicate fallback path in browser automation scripts prevents 64-bit Edge detection
    ...
    Suggested fix: Update the second entry in the fallback array to `'C:\\Program Files\\Microsoft\\Edge\\Application\\msedge.exe'`.
