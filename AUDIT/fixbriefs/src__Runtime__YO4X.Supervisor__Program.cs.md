...
[1] [P1] Supervisor host lacks process supervision, restart backoff, and crash loop limits
    ...
    Suggested fix: Register a background worker service in `YO4X.Supervisor` that manages child strategy process execution, monitors exit codes, enforces exponential restart backoffs with configurable maximum attempt thresholds, and marks persistently failing strategies as permanently parked.
