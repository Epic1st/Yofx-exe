...
[1] [P2] Frontend documentation mandates nonexistent `src/test-fixtures` directory and `?fixture=dashboard` flag
    ...
    Suggested fix: Remove the phantom `src/test-fixtures` claims from `src/Frontend/YO4X.Web/README.md` (and `README.md:78`), and align `scripts/visual-qa.mjs` with the real API-driven mock and loading states.
