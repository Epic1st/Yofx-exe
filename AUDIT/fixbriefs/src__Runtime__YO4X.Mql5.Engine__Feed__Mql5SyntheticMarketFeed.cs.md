...
[1] [P2] Missing bounds validation on synthetic feed initialization properties enables non-advancing time
    ...
    Suggested fix: Add validation ensuring `PeriodMinutes > 0`, `Point > 0`, `StartPrice > 0`, and `MinimumPrice > 0`.
