...
[1] [P2] Unicode Line and Paragraph Separators unescaped in Markdown table cells
    ...
    Suggested fix: Add `UnicodeCategory.LineSeparator` and `UnicodeCategory.ParagraphSeparator` to the character replacement predicate.
