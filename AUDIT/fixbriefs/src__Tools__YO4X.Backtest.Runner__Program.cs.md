...
[1] [P3] Inconsistent banker's rounding in `TryStorableEquity` vs away-from-zero rounding in broker simulator
    ...
    Suggested fix: Use `MidpointRounding.AwayFromZero` in `TryStorableEquity`.
