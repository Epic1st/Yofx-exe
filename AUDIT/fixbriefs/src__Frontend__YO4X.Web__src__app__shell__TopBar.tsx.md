...
[1] [P3] TopBar user settings button lacks descriptive accessible name
    ...
    Suggested fix: Add `aria-label={`Open settings (${user.displayName})`}` or `title="Settings"` to the `<button>` element.
