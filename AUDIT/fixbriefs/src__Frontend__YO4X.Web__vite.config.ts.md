...
[1] [P2] Production build unconditionally emits full TypeScript source maps
    ...
    Suggested fix: Set `sourcemap: false` or conditionally toggle sourcemaps only for non-production modes (e.g., `sourcemap: mode !== 'production'`).
