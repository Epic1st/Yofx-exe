...
[1] [P3] Undisposed Process instance on external link navigation in Desktop Shell
    ...
    Suggested fix: Wrap the call in `using var process = Process.Start(...)` or discard and dispose the returned `Process` object.
