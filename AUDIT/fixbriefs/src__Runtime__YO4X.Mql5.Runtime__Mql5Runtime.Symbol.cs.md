...
[1] [P1] SymbolInfo and SeriesInfo out-parameter overloads unconditionally return true
    ...
    Suggested fix: Check whether the underlying symbol or series exists and has valid property data; return `false` and record `Mql5ErrorCodes.MarketUnknownSymbol` or `Mql5ErrorCodes.InvalidParameter` when property lookups fail.
