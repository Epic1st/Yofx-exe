...
[1] [P2] FixedClock.UtcNow property setter does not normalize non-UTC offsets to UTC
    ...
    Suggested fix: Back `UtcNow` with a private field and call `value.ToUniversalTime()` in the property setter.
