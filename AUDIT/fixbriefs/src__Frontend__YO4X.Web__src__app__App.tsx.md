...
[1] [P2] Unhandled promise rejection in launch overlay trigger
    ...
    Suggested fix: Wrap the `client.getStrategyDetail` call in a `try/catch` block within `startLaunch` to catch errors and surface an error message or toast rather than letting the promise reject unhandled.
