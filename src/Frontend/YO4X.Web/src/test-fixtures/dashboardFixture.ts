...
const snapshot: DashboardSnapshot = {
  ...
  summary: [
    { id: 'account', label: 'Broker account', value: 'MT5 demo connected', tone: 'success', icon: 'bank' },
    { id: 'strategies', label: 'Strategies analyzed', value: '198 files', tone: 'success', icon: 'file' },
    { id: 'deployment', label: 'Deployment', value: 'Ready', tone: 'success', icon: 'rocket' },
    { id: 'policy', label: 'Safety policy', value: 'Active', tone: 'success', icon: 'shield' },
    { id: 'gateway', label: 'Gateway', value: 'Evidence pending', tone: 'warning', icon: 'cloud' },
  ],
  readiness: [
    { id: 'account-binding', number: 1, label: 'Account binding', detail: 'Demo account linked and permissions validated.', state: 'proven', icon: 'user', evidence: 'Account fingerprint, environment, and permissions match the approved binding.' },
    { id: 'strategy-package', number: 2, label: 'Strategy package', detail: 'Package structure, signatures and schema verified.', state: 'proven', icon: 'folder', evidence: 'The selected package digest and conversion manifest are approved.' },
    { id: 'risk-policy', number: 3, label: 'Risk policy', detail: 'Risk rules, limits and circuit breakers validated.', state: 'proven', icon: 'shield', evidence: 'Effective policy v1.2 permits demo execution within bounded limits.' },
  ...
  strategies: [
    { id: 'adaptive', name: 'Adaptive Strategy', sourceType: 'MQ5', state: 'Analyzed', featureCount: 24, reportPath: '#adaptive' },
    { id: 'apex', name: 'APEX M15 Scalper', sourceType: 'MQ5', state: 'Analyzed', featureCount: 18, reportPath: '#apex' },
    { id: 'bollinger', name: 'Bollinger Grid Hedge', sourceType: 'MQ5', state: 'Analyzed', featureCount: 22, reportPath: '#bollinger' },
    { id: 'breakout', name: 'Breakout Retest Pro', sourceType: 'MQ5', state: 'Review required', featureCount: 19, reportPath: '#breakout' },
    { id: 'gold-snap', name: 'Gold Snap', sourceType: 'MQ5', state: 'Analyzed', featureCount: 16, reportPath: '#gold-snap' },
  ],
  activity: [
