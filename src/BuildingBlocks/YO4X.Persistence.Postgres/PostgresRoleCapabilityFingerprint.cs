...
public static class Yo4xPostgresRoleContracts
{
    ...
    public static PostgresRoleCapabilityContract ControlApi { get; } = new(
        ...
        [
            ...
            "identity.tenants|SELECT",
            "identity.user_account_directory|SELECT",
            "identity.user_credentials|INSERT",
            "identity.user_credentials|SELECT",
            "identity.user_credentials|UPDATE",
            "identity.user_identities|SELECT",
            "identity.user_profiles|INSERT",
            "identity.user_profiles|SELECT",
        ...
        [
            ...
            Columns("operations.broker_accounts", "SELECT",
                "account_mode,binding_fingerprint,broker_hosted_stop_loss,broker_hosted_take_profit,broker_id,broker_profile_id,capability_evidence_sha256,capability_observed_at,capability_valid_until,created_at,credential_state,dedicated_cloud_use,environment,id,login_number,manual_or_external_trading_detected,masked_login,row_version,server,state,supports_deal_history,supports_order_query,supports_position_query,tenant_id,trading_allowed,updated_at,user_id"),
            Columns("operations.broker_accounts", "INSERT",
                "binding_fingerprint,broker_id,broker_profile_id,environment,id,login_number,masked_login,server,tenant_id,user_id"),
